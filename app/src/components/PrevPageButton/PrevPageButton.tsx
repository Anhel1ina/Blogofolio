import styles from './page_buttons.module.scss'
...
export const PrevPageButton = ({disabled = false}: Props) => {
    ...
    return (
        <button onClick={() => onPageClick(page! - 1)} disabled={disabled} className={styles.buttons_style}>
